  ...
  return (
    <>
      ...
      <div className="px-6 min-h-screen pb-6">
        <h1 className="text-3xl font-bold text-center mb-4">İstatistiklerim</h1>
        <div className="statistic-section">
          <h2 className="text-base mb-4">
            Hoş geldin{" "}
            <span className="text-green-700 font-bold text-xl">{user.username}</span>.
          </h2>
          <div className="statistic-cards grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-4 mb-8">
          ...
          <div className="flex justify-between gap-6 lg:flex-row flex-col items-center">
            <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/3 h-72">
              <Area {...config} />
            </div>
            <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/3 h-72">
              <Pie {...config2} />
